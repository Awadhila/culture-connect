<footer class="mt-5">
    ...
    <div class="main-footer py-5 text-white">
        <div class="container">
            <div class="row align-items-start">
                
                <div class="col-md-2 mb-4 text-start">
                    <h6 class="footer-heading mb-3">Find Us</h6>
                    <p class="footer-text">
                        Culture Connect<br>
                        College Lane<br>
                        Hatfield<br>
                ...
                <div class="col-md-2 mb-4 d-flex flex-column align-items-md-end text-md-end">
                    <h6 class="footer-heading mb-3">Members</h6>
                    <p class="footer-text">
                        Ahmed Salim<br>
                        Awadh Salim<br>
                        Dhanusha Tharanga<br>
                        Joyel<br>
                        Effiom Effanga
                    </p>
                </div>
                ...
                <div class="col-md-2 mb-4 d-flex flex-column align-items-md-end text-md-end">
                    <h6 class="footer-heading mb-3">Module</h6>
                    <p class="footer-text">
                        7COM1039<br>
                        Software<br>
                        Engineering
